...
import { normalize } from '../../util/NormalizeSize'
        ...
        >
          {this.props.children ? (
            this.props.children
              ...
              <View
                style={[styles.touchFlag, { marginTop: isEmojiable ? 0 : 0, flexDirection: 'row' }]}
              >
                ...
                }} >{this.props.countryCode}</Text>

                <Image source={icArrowDown} style={{ marginEnd: 10 }} />
              </View>
            )}
        </TouchableOpacity>
        <Modal
